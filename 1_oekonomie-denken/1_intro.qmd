...
Abbildung 1: Disziplinäre Verortung der Wirtschaftswissenschaften [@engelkampEinfuehrungVolkswirtschaftslehre2013, p. 3]
...
Die Videos finden Sie über diesen Link. [video auf opencast, dann hier einbetten]


::: {.callout-tip collapse="true"}
### Exkurs: Geschichte des Homo Oeconomicus (nur bei Interesse)
...
::: {.callout-tip collapse="true"}
### Exkurs: Müssen Annahmen realistisch sein? (Nur bei Interesse)
...
Ein erster Annäherungspunkt bietet der oft gezogener Gegensatz in Debatten um eine nachhaltigere Wirtschaft ist jener zwischen **Green Growth** und **Postwachstum**[^3] (Verweis auf Kapitel).
